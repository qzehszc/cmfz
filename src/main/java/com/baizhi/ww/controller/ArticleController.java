...
import com.baizhi.ww.util.UploadUtil;
...
public class ArticleController {
    ...
    public void uploadArticle(MultipartFile img, String articleId, HttpSession session) {
        System.out.println("uploadArticle：文件上传");
        System.out.println("MultipartFile："+ img);
        // 获取真实路径
        ...
        if(originalFilename.equals("")){
            ...
            Article.setImg("/upload/articleImg/"+"默认头像.jpg");
            articleService.update(Article);
        }else {
            Article Article = new Article();
            Article.setId(articleId);
