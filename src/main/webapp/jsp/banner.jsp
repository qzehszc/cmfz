...
<script type="text/javascript">
    $(function () {
        $("#bannerList").jqGrid({
            ...
            datatype:"json",
            colNames:["ID","标题","图片","状态","创建时间","描述"],
            colModel:[
                {name:"id"},
                {name:"title",editable:true},
                {name:"url",editable:true,edittype:"file",
                    formatter:function (val,row,rowJson) {
                        return "<img style='width:100px;height:50px' src='${pageContext.request.contextPath}/upload/img/"+val+"' />"
                    }
                },
        ...
        $("#bannerList").jqGrid("navGrid","#bannerPager",{add:true,edit:true,del:true,edittext:"编辑",addtext:"添加",deltext:"删除"},
            {//在编辑之前或者之后进行额外的操作
                closeAfterEdit:true,
