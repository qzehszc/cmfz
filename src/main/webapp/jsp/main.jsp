                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="${path}/img/图8.jpg" alt="First slide" width="1280" height="700">
                            <div class="carousel-caption">标题 1</div>
                        </div>
                        <div class="item">
                            <img src="${path}/img/图10.jpg" alt="Second slide" width="1280" height="700">
                            <div class="carousel-caption">标题 2</div>
                        </div>
                        <div class="item">
                            <img src="${path}/img/图9.jpg" alt="Third slide" width="1280" height="700">
                            <div class="carousel-caption">标题 3</div>
                        </div>
                        <div class="item">
                            <img src="${path}/img/图7.jpg" alt="Fourth slide" width="1280" height="700">
                            <div class="carousel-caption">标题 4</div>
                        </div>
                        <div class="item">
                            <img src="${path}/img/图5.jpeg" alt="Rosenrot slide" width="1280" height="700">
